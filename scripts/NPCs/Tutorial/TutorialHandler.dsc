# | ███████████████████████████████████████████████████████████
# % ██   Task Scripts to be Ran throughout stages of Tutorial
# % ██   To begin, use - run Tutorial_Start_Task
# | ██
# % ██ [ Start Script ] ██
...
Tutorial_Start_Task:
  ...
  script:
    ...
    - narrate "Before you begin, have a read through the controls guide in your handbook. When you're ready to get started, click on the Gielinor Guide, or just say hi to him. He is indicated by a flashing yellow arrow."
...
Tutorial_Handler:
  ...
  events:
    ...
    on player right clicks oak_door:
      ...
      - if MagicDoor:
        - zap "Gielinor Guide_Interact" End
